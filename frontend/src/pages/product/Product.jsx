                ...
                <div className="product-details">
                    ...
                    <div className="product-price">
                        {productData.sizes && productData.sizes.length > 0 ? (
                            ...
                            <span>
                                {productData.price || 'Prix non défini'} {currency}
                            </span>
                        )}
                    </div>
                    ...
                    <div className="action-buttons">
                        <button
                            onClick={() =>
                                addToCart(productData._id, size?.size || 'unique')
                            }
                        ...
                        >
                            {productData.sizes?.length > 0 && !size
                                ...
                                : <>
                                    <ShoppingCart size={20} strokeWidth={2} style={{ marginRight: '8px' }} />
